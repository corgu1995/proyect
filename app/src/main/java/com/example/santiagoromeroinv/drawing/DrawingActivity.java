...
public class DrawingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordsText = (TextView) findViewById(R.id.tvWordsSent);
    ...
    public void saveDrawing(View view){
        ...
        saveDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                byteArray = convert();
                SettingsActivity.getService().enviar(byteArray);
    ...
    public void sendWordAction(View view){
        ...
        SettingsActivity.getService().enviar(word.getBytes());
        Toast.makeText(DrawingActivity.this, ""+Constants.isSlave(), Toast.LENGTH_SHORT).show();
    }

    public static void setWordsText(String mensaje) {
        wordsText.setText(wordsText.getText()+"\n"+mensaje);
    }
}
